...
<section id="about" class="shadow-blue white-bg padding">
    ...
    <div class="row">
        <div class="col-md-3">
            <img src="static/user/picture/about.png" alt="about" />
        </div>
        <div class="col-md-9">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6">
            ...
            <div class="skill-item">
                ...
                <div class="progress">
                    <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="60"></div>
                </div>
...
<!-- section facts -->
<section id="facts" class="shadow-dark color-white background parallax padding-50" data-image-src="static/user/images/background-1.jpg">
...
<section id="works" class="shadow-blue white-bg padding">
    ...
    <div class="pf-filter-wrapper mb-4">
        <select class="portfolio-filter-mobile"><option value="*">Everything</option><option value=".creative">Creative</option><option value=".video">Video</option><option value=".design">Design</option><option value=".branding">Branding</option></select>
    </div>
    <!-- portolio wrapper -->
        ...
        <div class="col-md-4 col-sm-6 grid-item video">
            <a href="work-single.html">
                <div class="portfolio-item">
                    ...
                    <div class="thumb">
                        <img src="static/user/picture/1.jpg" alt="Portfolio-title" />
                        <div class="mask"></div>
                    </div>
                </div></a>
        </div>
        ...
        <div class="col-md-4 col-sm-6 grid-item creative design">
            <a href="work-single.html">
                <div class="portfolio-item">
                    ...
                    <span class="plus-icon">+</span>
                    <div class="thumb">
                        <img src="static/user/picture/2.jpg" alt="Portfolio-title" />
                        <div class="mask"></div>
                    </div>
                </div></a>
        </div>
        ...
        <div class="col-md-4 col-sm-6 grid-item branding">
            <a href="work-single.html">
                <div class="portfolio-item">
                    ...
                    <span class="plus-icon">+</span>
                    <div class="thumb">
                        <img src="static/user/picture/3.jpg" alt="Portfolio-title" />
                        <div class="mask"></div>
                    </div>
                </div></a>
        </div>
        ...
        <div class="col-md-4 col-sm-6 grid-item creative">
            <a href="work-single.html">
                <div class="portfolio-item">
                    ...
                    <span class="plus-icon">+</span>
                    <div class="thumb">
                        <img src="static/user/picture/4.jpg" alt="Portfolio-title" />
                        <div class="mask"></div>
                    </div>
                </div></a>
        </div>
        ...
        <div class="col-md-4 col-sm-6 grid-item video branding">
            <a href="work-single.html">
                <div class="portfolio-item">
                    ...
                    <span class="plus-icon">+</span>
                    <div class="thumb">
                        <img src="static/user/picture/5.jpg" alt="Portfolio-title" />
                        <div class="mask"></div>
                    </div>
                </div></a>
        </div>
        ...
        <div class="col-md-4 col-sm-6 grid-item creative design">
            <a href="work-single.html">
                <div class="portfolio-item">
                    ...
                    <span class="plus-icon">+</span>
                    <div class="thumb">
                        <img src="static/user/picture/6.jpg" alt="Portfolio-title" />
                        <div class="mask"></div>
                    </div>
                </div></a>
        </div>
    ...
    <div class="row testimonials-wrapper">
        <div class="col-md-6">
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-details">
                    <div class="thumb">
                        <img src="static/user/picture/customer-1.png" alt="customer-name" />
                    </div>
                    <div class="info">
                        <h4>Helen Doe</h4>
        ...
        <div class="col-md-6">
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-details">
                    <div class="thumb">
                        <img src="static/user/picture/customer-2.png" alt="customer-name" />
                    </div>
                    <div class="info">
                        <h4>Jane Doe</h4>
                        <span>Themeforest customer</span>
    ...
    <div class="clients-wrapper row">
        <div class="col-md-3">
            ...
            <div class="client-item">
                <div class="inner">
                    <img src="static/user/picture/1.png" alt="client-name" />
                </div>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="client-item">
                <div class="inner">
                    <img src="static/user/picture/2.png" alt="client-name" />
                </div>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="client-item">
                <div class="inner">
                    <img src="static/user/picture/3.png" alt="client-name" />
                </div>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="client-item">
                <div class="inner">
                    <img src="static/user/picture/4.png" alt="client-name" />
                </div>
            </div>
        </div>
        <div class="col-md-3">
...
<section id="blog" class="shadow-blue white-bg padding">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="blog-item">
                <div class="thumb">
                    <a href="#"><span class="category">Thoughts</span></a>
                    <a href="#"><img src="static/user/picture/1.jpg" alt="blog-title" /></a>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="blog-item">
                <div class="thumb">
                    <a href="#"><span class="category">Blog</span></a>
                    <a href="#"><img src="static/user/picture/2.jpg" alt="blog-title" /></a>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="blog-item">
                <div class="thumb">
                    ...
                    <a href="#"><img src="static/user/picture/3.jpg" alt="blog-title" /></a>
                </div>
