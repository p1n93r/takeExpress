                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block bg-login-image" >
                            ...
                            <div style="text-align: center;padding-top: 40%;color: white">
                                项目内容介绍
                                <p>校园快递代取系统是为了方便学生....</p>
                            </div>
                            ...
                            <div class="p-5">
                                ...
                                <div id="login1">
                                    <form class="user" id="loginForm" name="loginForm" onsubmit="return false;">
                                        ...
                                        <font color="red"></font>
                                        <button type="button" class="btn btn-success btn-user btn-block" id="loginsubmit">登录</button>
                                        <hr>
                                    </form>
                                </div>
                                <div id = "phone_login" style="display: none;">
                                    <form class="user" action="" onsubmit="return false" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user table_input" id="phone" name="phone"  onblur="checkPhone();" placeholder="请输入手机号" style="width: 100%">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="table_input" id="code" name="code" placeholder="    请输入验证码" style="width: 70%;padding-left: 15px;font-size: 10px" onkeydown="keyByPhoneLogin()">
                                        ...
                                        <font color="red"></font>
                                        <button type="submit" class="btn btn-primary btn-user btn-block" id="phonelogin" onClick="submit_phone();" onkeydown="keyByPhoneLogin()">登录</button>
                                        <hr>
                                    </form>
                                </div>
                                <div id = "face_login" style="display: none;">
                                    <dl class="admin_login">
                                        ...
                                        <dd>
                                            <input type="button" onclick="query()" value="立即登录" class="submit_btn" onkeydown="keyByFaceLogin()" />
                                        </dd>
                                    </dl>
                                </div>
                                </div>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="registerView">注册账号!</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    */
    ...
    var LOGIN = {
        ...
        doLogin:function() {
            $.post("./idLogin.do", $("#loginForm").serialize(),function(data){
                if (data.status == 200) {
                    if (redirectUrl == "") {
